"""
Shipday Data Ingestion
======================
Receives Shipday delivery data from n8n and stores it in the database.
n8n's [Evidence Collection] Shipday Delivery Collector workflow fetches from
the Shipday API and POSTs the order data here — Python never calls Shipday directly.

Endpoints:
  POST /api/shipday/ingest-orders            — Accept orders from n8n and store in DB
